...
update-database: ## Execute 'diff' and 'migrate'
	@$(DC_CMD) exec -T fpm /var/www/symfony/bin/console make:migration --no-interaction
	@$(DC_CMD) exec -T fpm /var/www/symfony/bin/console doctrine:migrations:migrate --no-interaction
